...
public class FlipdotsSmallFont extends HashMap<Character, Integer[]> {
    ...
    public FlipdotsSmallFont() {
        ...
        this.put('0', new Integer[]{62, 65, 65, 62, 0});
        this.put('1', new Integer[]{0, 66, 127, 64, 0});
        this.put('2', new Integer[]{98, 81, 73, 70, 0});
        this.put('3', new Integer[]{34, 65, 73, 54, 0});
        this.put('4', new Integer[]{56, 36, 34, 127, 32});
        this.put('5', new Integer[]{79, 73, 73, 49, 0});
        this.put('6', new Integer[]{62, 73, 73, 50, 0});
        this.put('7', new Integer[]{3, 1, 1, 127, 0});
        this.put('8', new Integer[]{54, 73, 73, 54, 0});
        this.put('9', new Integer[]{38, 73, 73, 62, 0});
