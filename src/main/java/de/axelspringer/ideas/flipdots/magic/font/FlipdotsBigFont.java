...
public class FlipdotsBigFont extends HashMap<Character, FlipdotBigByte[]> {
    ...
    public FlipdotsBigFont() {
        ...
        this.put('0', bigFontArray(intA(0, 124, 126, 7, 3, 67, 99, 115, 55, 126, 124, 0), intA(0, 31, 63, 118, 103, 99, 97, 96, 112, 63, 31, 0)));
        this.put('1', bigFontArray(intA(0, 0, 0, 0, 12, 14, 127, 127, 0, 0, 0, 0), intA(0, 0, 0, 0, 96, 96, 127, 127, 96, 96, 0, 0)));
        this.put('2', bigFontArray(intA(0, 12, 14, 71, 67, 67, 67, 67, 103, 126, 60, 0), intA(0, 126, 127, 99, 97, 97, 97, 97, 97, 96, 96, 0)));
        this.put('3', bigFontArray(intA(0, 12, 14, 7, 3, 67, 67, 67, 103, 126, 60, 0), intA(0, 24, 56, 112, 96, 97, 97, 97, 115, 63, 30, 0)));
        this.put('4', bigFontArray(intA(0, 64, 96, 112, 56, 28, 14, 127, 127, 0, 0, 0), intA(0, 7, 7, 6, 6, 6, 6, 127, 127, 6, 6, 0)));
        this.put('5', bigFontArray(intA(0, 63, 63, 51, 51, 51, 51, 51, 115, 99, 67, 0), intA(0, 24, 56, 112, 96, 96, 96, 96, 112, 63, 31, 0)));
        this.put('6', bigFontArray(intA(0, 124, 126, 71, 67, 67, 67, 67, 71, 14, 12, 0), intA(0, 31, 63, 113, 97, 97, 97, 97, 115, 63, 30, 0)));
        this.put('7', bigFontArray(intA(0, 3, 3, 3, 3, 3, 67, 99, 115, 63, 31, 0), intA(0, 0, 0, 0, 0, 127, 127, 1, 0, 0, 0, 0)));
        this.put('8', bigFontArray(intA(0, 60, 126, 103, 67, 67, 67, 67, 103, 126, 60, 0), intA(0, 30, 63, 115, 97, 97, 97, 97, 115, 63, 30, 0)));
        this.put('9', bigFontArray(intA(0, 60, 126, 103, 67, 67, 67, 67, 71, 126, 124, 0), intA(0, 24, 56, 113, 97, 97, 97, 97, 113, 63, 31, 0)));
        this.put(':', bigFontArray(intA(0, 28, 28, 28, 0), intA(0, 28, 28, 28, 0)));
    }
